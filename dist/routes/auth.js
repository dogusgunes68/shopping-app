...
router.post("/login-admin", (0, validateBody_1.validateBody)(validate_admin_body_1.adminValidation), auth_admin_1.loginAdminController);
...
router.post("/login-customer", (0, validateBody_1.validateBody)(validate_customer_body_1.customerValidation), auth_customer_1.loginCustomerController);
